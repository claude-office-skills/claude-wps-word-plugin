...
function OnOpenClaudePanel() {
  // #region agent log
  fetch('http://127.0.0.1:7244/ingest/63acb95d-6f91-4165-a07a-5bab2abb61eb',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'38bc8c'},body:JSON.stringify({sessionId:'38bc8c',location:'word/public/main.js:OnOpenClaudePanel',message:'OnOpenClaudePanel called',data:{TASKPANE_URL:TASKPANE_URL},timestamp:Date.now(),hypothesisId:'H-word-click'})}).catch(function(){});
  // #endregion
  try {
    var tsId = null;
    try {
...
window.ribbon_bindUI = function (bindUI) {
  // #region agent log
  fetch('http://127.0.0.1:7244/ingest/63acb95d-6f91-4165-a07a-5bab2abb61eb',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'38bc8c'},body:JSON.stringify({sessionId:'38bc8c',location:'word/public/main.js:ribbon_bindUI',message:'ribbon_bindUI called',data:{},timestamp:Date.now(),hypothesisId:'H-word-ribbon-load'})}).catch(function(){});
  // #endregion
  bindUI({
